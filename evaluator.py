...
class Evaluator:
    ...
    def _binary_from_confidence(self):
        conf_scores = self.scores_by_method.get("confidence")
        raise NotImplementedError(f"Not implemented")

    def _binary_from_variability(self):
        var_scores = self.scores_by_method.get("variability")
        raise NotImplementedError(f"Not implemented")

    def _binary_from_correctness(self):
        correctness = self.scores_by_method.get("correctness")
        raise NotImplementedError(f"Not implemented")
